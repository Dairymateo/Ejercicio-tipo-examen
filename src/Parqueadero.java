...
// -----------------------------------------------------------------
     ...
     */
    public int entrarCarro( String pPlaca, int pHora )
    {
        int resultado = 0;
        if( !abierto )
        {
        ...
        else
        {
            ...
            {
                Carro carroEntrando = new Carro( pPlaca, pHora );
     ...
     */
    public int sacarCarro( String pPlaca, int pHoraSalida )
    {
        int resultado = 0;
        if( !abierto )
        {
        ...
        else
        {
            ...
            else
            {
                ...
                int nHoras = carro.darTiempoEnParqueadero(pHoraSalida);
    ...
    /*public double darTiempoPromedio(int pHoraSalida) {
        for (Puesto pp : puestos) {
            {
                int promedio = 0;
                int contador = 0;
                if (pp.estaOcupado()) {
                    promedio += pp.darCarro().darTiempoEnParqueadero(pp.darCarro().darHoraSalida(pHoraSalida));
                    contador++;
                }
